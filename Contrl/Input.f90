...
!          read(*,*)onpcol,onprow
          ...
          open(unit=13,file='test.in',status='old')
...
!        print*,"nchrg: ",onchrg
!        print*,"curr: ",ocurrlist(1:onchrg)
!        print*,"npt: ",onptlist(1:onchrg)
!        print*,"qmcc: ",oqmcclist(1:onchrg)
!        print*,"param: ",distparam(1),distparam(2)
